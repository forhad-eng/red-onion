    ...
    return (
        <div>
            <div className="home-banner">
                ...
                <div className="w-1/2 mx-auto flex justify-center items-center relative">
                    <input
                        className="rounded-full text-sm outline-none py-1 px-4 md:px-0 md:mr-16 md:py-2 md:pl-5 md:pr-32"
                        type="text"
                        placeholder="Search food items"
                    />
                    <button className="text-sm text-white outline-none bg-red-500 px-5 py-1 md:py-2 rounded-full absolute -right-10 md:right-[40px] lg:right-[90px] xl:right-[140px]">
                        Search
                    </button>
                </div>
            </div>
